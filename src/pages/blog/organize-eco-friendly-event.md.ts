...
- 💨 **Emissions** — shared attendee transport, renewable energy, low-carbon catering, regional artists, offsets. The biggest single lever lives here. Guide: https://caribbean.countdowns.co/blog/eco-events-emissions
...
- 🐢 **Biodiversity** — distance from protected areas, wildlife briefings, leave-no-trace, light-pollution control, eco NGO onboarding. _(coming soon)_
- 🤝 **Community** — local vendors and line-up, NGO partnership, accessible pricing, social inclusion. _(coming soon)_
