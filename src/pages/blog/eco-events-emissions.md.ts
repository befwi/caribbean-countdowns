...
- 🚗 **Carsharing** — event code / drop-off zone with a local operator.
- 🚕 **Taxi / VTC** — group flat rate + signposted pickup with a co-op or VTC; number on tickets.
- 🚌 **Shuttle** — charter a bus company for loops from relay car parks.
- 👥 **Carpool** — event page on a carpool platform or a shared form; reserve the best parking for full cars.
