...
var CRITERIA = [
  {
    ...
    criteria: [
      { key: "attendeeTransport",
        ...
        tip: { en: "Organize at least one shared-transport option (shuttle, carpool, carsharing, transit) and promote it on every ticket — attendee travel is the single biggest emission source. <a href=\"/blog/eco-events-emissions/#attendeeTransport\" class=\"tip-more\">Learn more →</a>", fr: "Organisez au moins une option de transport partagé (navette, covoiturage, autopartage, transports) et affichez-la sur chaque billet — le trajet du public est la première source d'émissions. <a href=\"/blog/eco-events-emissions/#attendeeTransport\" class=\"tip-more\">En savoir plus →</a>", kr: "Òganize omwen yon opsyon transpò patajé (navèt, kovwatiraj, otopataj, transpò an komen) epi pibliye li sou chak tikèt — vwayaj piblik la se premye sous emisyon. <a href=\"/blog/eco-events-emissions/#attendeeTransport\" class=\"tip-more\">Aprann plis →</a>", es: "Organiza al menos una opción de transporte compartido (lanzadera, coche compartido, carsharing, transporte público) y anúnciala en cada entrada — el viaje del público es la mayor fuente de emisiones. <a href=\"/blog/eco-events-emissions/#attendeeTransport\" class=\"tip-more\">Más información →</a>" }
      },
      { key: "renewableEnergy",
        ...
        tip: { en: "Use grid power or rent solar/battery generators — diesel gensets are the top on-site emission source. <a href=\"/blog/eco-events-emissions/#renewableEnergy\" class=\"tip-more\">Learn more →</a>", fr: "Utilisez le réseau électrique ou louez des générateurs solaires/batteries — les groupes diesel sont la première source d'émissions sur site. <a href=\"/blog/eco-events-emissions/#renewableEnergy\" class=\"tip-more\">En savoir plus →</a>", kr: "Itilize kouran rezo a oswa lwe jeneratè solè/batri — jeneratè dyèzèl se premye sous emisyon sou sit. <a href=\"/blog/eco-events-emissions/#renewableEnergy\" class=\"tip-more\">Aprann plis →</a>", es: "Usa la red eléctrica o alquila generadores solares/batería — los grupos diésel son la mayor fuente de emisiones in situ. <a href=\"/blog/eco-events-emissions/#renewableEnergy\" class=\"tip-more\">Más información →</a>" }
      },
      { key: "carbonOffset",
        ...
        tip: { en: "Offset unavoidable emissions (artist flights, freight) via a Gold Standard/VCS scheme funded by a €1–2 ticket levy; publish the tonnes. <a href=\"/blog/eco-events-emissions/#carbonOffset\" class=\"tip-more\">Learn more →</a>", fr: "Compensez les émissions inévitables (vols des artistes, fret) via un programme Gold Standard/VCS financé par 1–2 € par billet ; publiez les tonnes. <a href=\"/blog/eco-events-emissions/#carbonOffset\" class=\"tip-more\">En savoir plus →</a>", kr: "Konpanse emisyon inevitab yo (vòl artis, fret) atravè yon pwogram Gold Standard/VCS ki finanse pa 1–2 € pa tikèt ; pibliye tòn yo. <a href=\"/blog/eco-events-emissions/#carbonOffset\" class=\"tip-more\">Aprann plis →</a>", es: "Compensa las emisiones inevitables (vuelos de artistas, fletes) con un programa Gold Standard/VCS financiado con 1–2 € por entrada; publica las toneladas. <a href=\"/blog/eco-events-emissions/#carbonOffset\" class=\"tip-more\">Más información →</a>" }
      },
      { key: "localHeadliners",
        ...
        tip: { en: "Prioritise Caribbean/regional artists — a transatlantic act + crew can equal a 2,000-person festival's ground transport. <a href=\"/blog/eco-events-emissions/#localHeadliners\" class=\"tip-more\">Learn more →</a>", fr: "Privilégiez les artistes caribéens/régionaux — un artiste transatlantique + équipe peut égaler l'empreinte transport d'un festival de 2 000 personnes. <a href=\"/blog/eco-events-emissions/#localHeadliners\" class=\"tip-more\">En savoir plus →</a>", kr: "Bay priyorite artis Karayib/rejyonal — yon artis transatlantik + ekip ka egal transpò yon festival 2 000 moun. <a href=\"/blog/eco-events-emissions/#localHeadliners\" class=\"tip-more\">Aprann plis →</a>", es: "Prioriza artistas caribeños/regionales — un artista transatlántico + equipo puede igualar el transporte terrestre de un festival de 2.000 personas. <a href=\"/blog/eco-events-emissions/#localHeadliners\" class=\"tip-more\">Más información →</a>" }
      },
      { key: "lowCarbonCatering",
        ...
        tip: { en: "Require each vendor to feature at least one plant-based dish — food is ~25% of global emissions. <a href=\"/blog/eco-events-emissions/#lowCarbonCatering\" class=\"tip-more\">Learn more →</a>", fr: "Exigez de chaque restaurateur au moins un plat végétal — l'alimentation représente ~25% des émissions mondiales. <a href=\"/blog/eco-events-emissions/#lowCarbonCatering\" class=\"tip-more\">En savoir plus →</a>", kr: "Mande chak vandè omwen yon pla vejetal — manje se ~25% emisyon mondyal yo. <a href=\"/blog/eco-events-emissions/#lowCarbonCatering\" class=\"tip-more\">Aprann plis →</a>", es: "Exige a cada vendedor al menos un plato vegetal — la comida es ~25% de las emisiones mundiales. <a href=\"/blog/eco-events-emissions/#lowCarbonCatering\" class=\"tip-more\">Más información →</a>" }
      }
    ]
  },
  {
