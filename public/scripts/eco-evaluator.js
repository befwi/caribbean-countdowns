...
var CRITERIA = [
  {
    ...
    criteria: [
      ...
      { key: "carbonOffset",
        ...
        tip: { en: "In the Caribbean, island isolation makes certain emissions unavoidable (artist flights, freight). Partner with Label Bas Carbone, Gold Standard or VCS-certified scheme to offset them — even a small ticket levy (€1–2 per ticket) is enough to cover the average festival footprint. Publish the total tonnes offset alongside ticket sales.", fr: "Dans la Caraïbe, l'isolement insulaire rend certaines émissions inévitables (vols des artistes, fret). Associez-vous à un programme certifié Label Bas Carbone ou Gold Standard — même une petite contribution billetterie (1–2 € par billet) suffit à couvrir l'empreinte moyenne d'un festival. Publiez le total de tonnes compensées avec vos données de billetterie.", kr: "Nan Karayib la, izolasyon zile a fè kèk emisyon inévitab (vòl artist, fret). Asosye ak yon pwogram sètifye Label Bas Carbone oswa Gold Standard, menm yon ti kontribisyon tikèt (1–2 € pa tikèt) ase pou kouvri emprènt mwayen yon festivàl. Pibliye total tòn konpanse ansanm ak done tikèt ou yo.", es: "En el Caribe, el aislamiento insular hace que ciertas emisiones sean inevitables (vuelos de artistas, fletes). Asóciate con un programa certificado Label Bas Carbone o Gold Standard incluso un pequeño recargo por entrada (1–2 € por entrada) es suficiente para cubrir la huella media de un festival. Publica las toneladas compensadas junto con los datos de venta de entradas." }
      },
      { key: "localHeadliners",
